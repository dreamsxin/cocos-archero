...
export class GameManager extends Component {
    ...
    private _onGameInit () {   
        ...
        //判断是否是第一次加载游戏，是的话刷新关卡，否则的话通过loadingPanel去刷新关卡
